...
export default function LoginPage() {
  ...
  return (
    <main className={`flex min-h-svh items-center justify-center bg-background p-6 ${GLASS_BACKGROUND_GRADIENT_CLASS}`}>
      <div className={`flex w-full max-w-3xl overflow-hidden rounded-xl ${GLASS_CARD_CLASS}`}>
